...
function ccfwoo_core_enqueue_scripts() {
	...
	wp_enqueue_style( 'ccfwoo-style', plugin_dir_url( __FILE__ ) . '../assets/checkout-countdown.min.css', array(), '4.0.0' );
	...
	wp_enqueue_script( 'ccfwoo-countdown', plugin_dir_url( __FILE__ ) . '../assets/checkout-countdown.min.js', array(), '4.0.0', true );
	...
	$data = array(
		...
		'cart_criteria' => ccfwoo_has_cart_criteria(),
	);
